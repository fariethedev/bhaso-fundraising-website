...
export function Layout245() {
  ...
  return (
    <section className="px-[5%] py-20 md:py-28 lg:py-32 bg-white flex flex-col items-center">
      <div className="max-w-5xl w-full text-center">
        <h2 className="text-green-900 text-4xl md:text-5xl font-bold mb-12">Our Journey</h2>

        {/* Period Title */}
        <h3 className="text-4xl font-extrabold text-green-900 mb-8">
          {currentItem.period}
        </h3>
        ...
        <div className="flex justify-center gap-8 mt-12">
          <button
            ...
            className="bg-green-900 hover:bg-green-800 text-white w-12 h-12 flex items-center justify-center rounded-full transition"
          >
            <svg
