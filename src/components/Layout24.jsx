...
export function Layout24() {
  ...
  return (
    <section id="relume" className="w-full bg-[#fcfcfa] px-[5%] py-20 md:py-28 text-gray-800">
      <motion.div
      ...
      >
        {/* Heading */}
        <h2 className="text-3xl md:text-5xl font-serif font-bold leading-tight mb-8 text-center max-w-[90%] text-[#113d29]">
          Our Journey & Impact
        </h2>

        {/* About text */}
        <div className="space-y-6 text-base md:text-lg leading-relaxed text-gray-700 max-w-full font-light">
          <p>
        ...
        <div className="mt-6 flex gap-4">
          <button
            ...
            disabled={!showMore}
            className={`p-3 rounded-full bg-[#113d29] hover:bg-[#14b8a6] transition-colors shadow-lg disabled:opacity-50 disabled:cursor-not-allowed`}
