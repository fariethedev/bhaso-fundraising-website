...
export function Footer12() {
  return (
    <footer className="px-[5%] py-12 md:py-16 lg:py-20 bg-[#113d29] text-white">
      <div className="container mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <Link
                  to="/contact"
                  className="px-4 py-2 border border-white/20 text-gray-300 hover:bg-[#14b8a6] hover:text-white hover:border-[#14b8a6] rounded text-sm transition"
                >
                  Partner With Us
                </Link>
              </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-8 gap-6">
          ...
          <div className="flex space-x-5">
            <a href="#" className="text-gray-400 hover:text-[#14b8a6] transition">
              <FaFacebookF size={18} />
            </a>
            <a href="#" className="text-gray-400 hover:text-[#14b8a6] transition">
              <FaTwitter size={18} />
          ...
          <div className="flex space-x-6">
            <Link to="/privacy" className="text-sm text-gray-400 hover:text-[#14b8a6] hover:underline font-light transition">
              Privacy Policy
            </Link>
            <Link to="/terms" className="text-sm text-gray-400 hover:text-[#14b8a6] hover:underline font-light transition">
              Terms of Service
            </Link>
            <Link to="/sitemap" className="text-sm text-gray-400 hover:text-[#14b8a6] hover:underline font-light transition">
              Sitemap
            </Link>
          </div>
        </div>
